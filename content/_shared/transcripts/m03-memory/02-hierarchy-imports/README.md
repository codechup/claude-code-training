# Transcript — m03-memory/02-hierarchy-imports

Raw Claude Code session recordings for this lesson's lab. **Real recordings only** (D070, D093,
D099): the writing session runs the lab in a scratch folder (this lesson has no lab-repo tag)
...
| ------------------------ | --------------------------------------------------------- | ----------- | ------------------- |
| `01-import-loads.txt`    | Step 4 - `@notes/conventions.md` import expands at launch | 2026-09-07  | 2.1.263             |
| `02-local-overrides.txt` | Step 6 - `CLAUDE.local.md` is read last at the same level | 2026-09-07  | 2.1.263             |
