...
> **TL;DR:** **M0** 12/13 done · **M1** 0/12 done · **M2** 0/15 done · **M3** 0/6 done · **M4** 0/2 done · 0 in progress · 1 in review · 0 blocked. Current wave (1 claimable): `P22`. Claim with `node tools/plan/cli.ts claim PNN --owner <name>`; regenerate this file with `node tools/plan/cli.ts state` — never hand-edit it.
...
|---|---|---|---|
| `P12` | Milestone M0 release | fable-lead-2026-09-07 | `plan/12-milestone-0-release` |
...
|---|---|---|---|
| `P12` | review | 2026-09-06T22:24:06Z | fable-lead-2026-09-07 |
