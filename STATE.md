...
> **TL;DR:** **M0** 13/13 done · **M1** 11/12 done · **M2** 0/15 done · **M3** 0/6 done · **M4** 0/2 done · 1 in progress · 0 in review · 0 blocked. Current wave (0 claimable): _None._. Claim with `node tools/plan/cli.ts claim PNN --owner <name>`; regenerate this file with `node tools/plan/cli.ts state` — never hand-edit it.
...
|---|---|---|---|---|---|
| `P24` | Milestone M1 release | sonnet-p24-2026-09-07 | `plan/24-milestone-1-release` | 2026-09-07T10:22:19Z | — |
...
| `P24` | in_progress | 2026-09-07T10:22:19Z | sonnet-p24-2026-09-07 |
