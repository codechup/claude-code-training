...
> **TL;DR:** **M0** 13/13 done · **M1** 0/12 done · **M2** 0/15 done · **M3** 0/6 done · **M4** 0/2 done · 0 in progress · 2 in review · 0 blocked. Current wave (0 claimable): _None._. Claim with `node tools/plan/cli.ts claim PNN --owner <name>`; regenerate this file with `node tools/plan/cli.ts state` — never hand-edit it.
...
|---|---|---|---|
| `P22` | Lab repository scaffold (codechup/claude-code-lab) | sonnet-p22-2026-09-07 | `plan/22-lab-repo-scaffold` |
| `P23` | Sources registry | haiku-p23-2026-09-07 | `plan/23-sources-registry` |
...
|---|---|---|---|
| `P22` | review | 2026-09-07T07:47:56Z | sonnet-p22-2026-09-07 |
| `P23` | review | 2026-09-07T07:21:28Z | haiku-p23-2026-09-07 |
