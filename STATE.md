...
> **TL;DR:** **M0** 13/13 done · **M1** 2/12 done · **M2** 0/15 done · **M3** 0/6 done · **M4** 0/2 done · 1 in progress · 3 in review · 0 blocked. Current wave (5 claimable): `P17`, `P18`, `P19`, `P20`, `P21`. Claim with `node tools/plan/cli.ts claim PNN --owner <name>`; regenerate this file with `node tools/plan/cli.ts state` — never hand-edit it.
...
|---|---|---|---|---|
| `P17` | L2 Intermediate module: Models and effort (m05-models-effort) | opus | high | L |
| `P18` | L2 Intermediate module: Skills (m06-skills) | opus | high | L |
| `P19` | L2 Intermediate module: Hooks (m07-hooks) | opus | high | L |
| `P20` | L2 Intermediate module: Git flows (m08-git) | opus | high | L |
| `P21` | L2 Intermediate module: Prompting (m09-prompting) | opus | high | L |

## In progress

| Plan | Title | Owner | Branch | Since | Stale |
|---|---|---|---|---|---|
| `P14` | L1 Beginner module: Interact (m02-interact) | opus-p14-2026-09-07 | `plan/14-l1-m02-interact` | 2026-09-07T07:57:33Z | — |
...
| `P14` | in_progress | 2026-09-07T07:57:33Z | opus-p14-2026-09-07 |
| `P22` | done | 2026-09-07T07:57:31Z | sonnet-p22-2026-09-07 |
| `P23` | done | 2026-09-07T07:57:31Z | haiku-p23-2026-09-07 |
| `P12` | done | 2026-09-07T00:45:14Z | fable-lead-2026-09-07 |
| `P11` | done | 2026-09-06T21:44:27Z | session-p11-2026-09-06 |
| `P09` | done | 2026-09-06T21:44:11Z | session-p09-2026-09-06 |
| `P07` | done | 2026-09-06T21:44:10Z | session-p07-2026-09-06 |
