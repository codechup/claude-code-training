...
> **TL;DR:** **M0** 6/13 done · **M1** 0/12 done · **M2** 0/15 done · **M3** 0/6 done · **M4** 0/2 done · 1 in progress · 1 in review · 0 blocked. Current wave (1 claimable): `P22`. Claim with `node tools/plan/cli.ts claim PNN --owner <name>`; regenerate this file with `node tools/plan/cli.ts state` — never hand-edit it.
...
|---|---|---|---|---|---|
| `P06` | 'Content pipeline: collections, routes, and landing' | fable-lead-2026-09-06 | `plan/06-content-pipeline` | 2026-09-06T19:48:09Z | — |
...
|---|---|---|---|
| `P10` | Deploy workflow and static host runbook | sonnet-p10-2026-09-06 | `plan/10-deploy-workflow` |

## Done

- **M0** (6): `P00`, `P01`, `P02`, `P03`, `P04`, `P05`
...
| `P10` | review | 2026-09-06T20:06:43Z | sonnet-p10-2026-09-06 |
| `P06` | in_progress | 2026-09-06T19:48:09Z | fable-lead-2026-09-06 |
