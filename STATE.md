...
> **TL;DR:** **M0** 12/13 done · **M1** 0/12 done · **M2** 0/15 done · **M3** 0/6 done · **M4** 0/2 done · 0 in progress · 0 in review · 1 blocked. Current wave (2 claimable): `P22`, `P23`. Claim with `node tools/plan/cli.ts claim PNN --owner <name>`; regenerate this file with `node tools/plan/cli.ts state` — never hand-edit it.
...
|---|---|---|---|
| `P12` | Milestone M0 release | fable-lead-2026-09-07 | Blocked (2026-09-06): static host vhost not live — owner gate: origin certificate secrets for the host-side vhost change, that repository's deploy switch, and the DNS record for cc; everything else in the acceptance criteria is met (docs/release/M0-release.md) |
...
- **M0** (12): `P00`, `P01`, `P02`, `P03`, `P04`, `P05`, `P06`, `P07`, `P08`, `P09`, `P10`, `P11`

## Recent changes

| Plan | Status | Updated | Owner |
|---|---|---|---|
| `P12` | blocked | 2026-09-06T22:35:46Z | fable-lead-2026-09-07 |
...
| `P08` | done | 2026-09-06T21:44:10Z | session-p08-2026-09-06 |
