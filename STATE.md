...
> **TL;DR:** **M0** 13/13 done · **M1** 12/12 done · **M2** 0/15 done · **M3** 0/6 done · **M4** 0/2 done · 6 in progress · 0 in review · 0 blocked. Current wave (8 claimable): `P31`, `P32`, `P33`, `P34`, `P35`, `P36`, `P37`, `P38`. Claim with `node tools/plan/cli.ts claim PNN --owner <name>`; regenerate this file with `node tools/plan/cli.ts state` — never hand-edit it.
...
|---|---|---|---|---|
| `P31` | L3 Advanced module: Security (m14-security) | opus | high | L |
| `P32` | L3 Advanced module: Platforms (m15-platforms) | opus | high | L |
...
| `P21` | done | 2026-09-07T10:22:19Z | opus-p21-2026-09-07 |
| `P16` | done | 2026-09-07T10:22:18Z | opus-p16-2026-09-07 |
