...
| Hooks | events: SessionStart, Setup, UserPromptSubmit, UserPromptExpansion, PreToolUse, PermissionRequest, PermissionDenied, PostToolUse, PostToolUseFailure, PostToolBatch, Notification, MessageDisplay, SubagentStart, SubagentStop, TaskCreated, TaskCompleted, Stop, StopFailure, TeammateIdle, InstructionsLoaded, ConfigChange, CwdChanged, DirectoryAdded, FileChanged, WorktreeCreate, WorktreeRemove, PreCompact, PostCompact, PreModelSwitch, PostModelSwitch, Elicitation, ElicitationResult; stdin/stdout JSON; exit 0 = ok (stdout parsed as JSON when it is an object), 2 = block on blocking events (PreToolUse, UserPromptSubmit, UserPromptExpansion, Stop, SubagentStop, WorktreeCreate), other = non-blocking; PreToolUse decisions via `hookSpecificOutput: {hookEventName, permissionDecision: allow|deny|block, permissionDecisionReason, additionalContext?, updatedInput?, systemMessage?}` | hooks (re-fetched 2026-09-06), hooks-guide |
