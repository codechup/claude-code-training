...
<!-- Trimmed fixture: the same three releases from the real
     https://code.claude.com/docs/en/changelog.md as fetched 2026-09-09,
     cut to six bullets each. This mirror is the only place release DATES appear. -->
